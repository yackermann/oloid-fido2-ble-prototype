...
import com.example.testblefido2.webauthn.Authenticator
import com.example.testblefido2.webauthn.TransactionManager
...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnBleTest.setOnClickListener {
            ...
            Thread {
                if (mauthr == null) {
                    mauthr = Authenticator(requireActivity(), false)
                }
                if (transactionManager == null) {
                    transactionManager = TransactionManager(requireActivity(), mauthr)
                }
