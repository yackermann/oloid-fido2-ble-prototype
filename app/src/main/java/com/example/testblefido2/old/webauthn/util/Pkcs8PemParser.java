...
public class Pkcs8PemParser {
    ...
    public static byte[] toBytes(String input, Pkcs8PemParser.Type type) throws IOException {
    ...
    public static PrivateKey toPrivateKey(String pk, KeyFactory kf)
        ...
        byte[] encodedBytes = Pkcs8PemParser.toBytes(pk, Pkcs8PemParser.Type.KEY);
    ...
    public static Certificate toCertificate(String cert, CertificateFactory cf)
        ...
        byte[] bCert = Pkcs8PemParser.toBytes(cert, Pkcs8PemParser.Type.CERT);
