package com.example.testblefido2.old.webauthn;
...
import com.example.testblefido2.R;
import com.example.testblefido2.old.webauthn.exceptions.ApduException;
import com.example.testblefido2.old.webauthn.exceptions.ApduException.StatusWord;
import com.example.testblefido2.old.webauthn.exceptions.CtapException;
import com.example.testblefido2.old.webauthn.exceptions.CtapException.CtapError;
import com.example.testblefido2.old.webauthn.exceptions.VirgilException;
import com.example.testblefido2.old.webauthn.fido.u2f.KnownFacets;
import com.example.testblefido2.old.webauthn.fido.u2f.RawMessages;
import com.example.testblefido2.old.webauthn.fido.u2f.RawMessages.Response;
import com.example.testblefido2.old.webauthn.models.AttestationObject;
import com.example.testblefido2.old.webauthn.models.AuthenticatorConfig;
import com.example.testblefido2.old.webauthn.models.AuthenticatorExtension;
import com.example.testblefido2.old.webauthn.models.DummyAttestation;
import com.example.testblefido2.old.webauthn.models.GetAssertionOptions;
import com.example.testblefido2.old.webauthn.models.GetAssertionResult;
import com.example.testblefido2.old.webauthn.models.GetInfoResult;
import com.example.testblefido2.old.webauthn.models.MakeCredentialOptions;
import com.example.testblefido2.old.webauthn.models.ClientPINOptions;
import com.example.testblefido2.old.webauthn.models.ClientPINResult;
import com.example.testblefido2.old.webauthn.models.NoneAttestation;
import com.example.testblefido2.old.webauthn.models.PackedBasicAttestation;
import com.example.testblefido2.old.webauthn.models.PublicKeyCredentialDescriptor;
import com.example.testblefido2.old.webauthn.models.PublicKeyCredentialSource;
import com.example.testblefido2.old.webauthn.models.U2fBatchAttestation;
import com.example.testblefido2.old.webauthn.util.ClientPinLocker;
import com.example.testblefido2.old.webauthn.util.CredentialSelector;
import com.example.testblefido2.old.webauthn.util.CredentialSafe;
import com.example.testblefido2.old.webauthn.util.WebAuthnCryptography;
import com.example.testblefido2.old.webauthn.util.WioBiometricPrompt;
import com.example.testblefido2.old.webauthn.util.WioBiometricPrompt.PromptCallback;
import com.example.testblefido2.old.webauthn.util.WioRequestDialog;
...
public final class Authenticator {
    ...
    private ClientPinLocker pinLocker;
     ...
     */
    public Authenticator(Context ctx, boolean strongboxRequired) throws VirgilException {

        this.credentialSafe = new CredentialSafe(ctx, strongboxRequired);
    ...
    public AttestationObject makeCredential(MakeCredentialOptions options, FragmentActivity activity) throws VirgilException, CtapException {
        ...
        if (options.requireUserVerification) {
            ...
            if (credentialSafe.biometricSigningSupported) {
                ...
                PrivateKey privateKey = credentialSafe.getKeyPairByAlias(credentialSource.keyPairAlias)
                                                        .getPrivate();
            ...
            permission = showDialog(activity,
                                    activity.getString(R.string.credentials_makeTitle, options.rpEntity.id),
                                    activity.getString(R.string.credentials_makeSubtitle));
        }
    ...
    public AttestationObject makeInternalCredential(MakeCredentialOptions options,
        ...
        return constructAttestationObject(authenticatorData, options.clientDataHash,
                                          credentialSource.keyPairAlias, signature);
    }
    ...
    public GetAssertionResult getAssertion(GetAssertionOptions options, CredentialSelector credentialSelector, FragmentActivity activity) throws CtapException, VirgilException {
        ...
        if (options.requireUserVerification || keyNeedsUnlocking) {
            ...
            if (credentialSafe.biometricSigningSupported) {
                biometricSignature = null;
                PrivateKey privateKey = credentialSafe.getKeyPairByAlias(selectedCredential.keyPairAlias)
                        .getPrivate();
                Signature signature = WebAuthnCryptography.generateSignatureObject(privateKey);
                cryptoObject = new CryptoObject(signature);
            }
            ...
            permission = showPrompt(activity,
                                    activity.getString(R.string.request_title, options.rpId),
                            txSimpleAuth + activity.getString(R.string.request_subtitle), cryptoObject
            );
            uv = permission;
        } else {
            permission = showDialog(activity,
                                    activity.getString(R.string.request_title, options.rpId),
                            txSimpleAuth + activity.getString(R.string.request_subtitleDialog));
        }
        ...
        GetAssertionResult result =  getInternalAssertion(options, selectedCredential,
                                                          biometricSignature, uv, extensionOutput);
    ...
    public GetAssertionResult getInternalAssertion(GetAssertionOptions options,
        ...
        return getInternalAssertion(options, selectedCredential, null, uv, extensionOutput);
    }
        ...
        switch (options.subCommand.intValue()) {
            ...
            case 1:
                ...
                result = new ClientPINResult(null, null,
                                                            pinLocker.getRetries());
                break;
            /* getKeyAgreement */
            case 2:
                Log.d(TAG, "getPIN subcommand -> getKeyAgreement");
                // Send public key aG
                Pair<byte[], byte[]> point = CredentialSafe.cosePointEncode(
                                                            authenticatorKeyAgreement.getPublic());
    ...
    public Response registerRequest(RawMessages.RegistrationRequest req,
        ...
        try {
            ...
            keyPair = credentialSafe.getKeyPairByAlias(credentialSource.keyPairAlias);
        ...
        try {
            u2fAuthData = U2fBatchAttestation.packU2fAuthData(
                    req.application,
                    req.challenge,
                    credentialSource.id,
                    serializedKey
        ...
        U2fBatchAttestation attestationObj;
        try {
            attestationObj = new U2fBatchAttestation(u2fAuthData, this.cryptoProvider);
        } catch (VirgilException e) {
            e.printStackTrace();
     ...
     */
    @SuppressLint("Assert")
    private AttestationObject constructAttestationObject(byte[] authenticatorData, byte[] clientDataHash, String keyPairAlias, Signature signature) {
...
//        return new PackedSelfAttestation(authenticatorData, signatureBytes);
