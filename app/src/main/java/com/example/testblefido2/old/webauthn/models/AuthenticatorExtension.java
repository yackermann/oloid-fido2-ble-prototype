...
public class AuthenticatorExtension {
    ...
    public DataItem process(KeyPair keyAgreement, CredentialSafe credentialSafe,
        ...
        switch (name) {
            case "hmac-secret":
                if (action == RequestCommandCTAP2.MakeCredential) {
                    ...
                    SecretKey key = credentialSafe.getSecretKeyByAlias(credentialSource.hmacSecretAlias);
                    byte[] output = null;
