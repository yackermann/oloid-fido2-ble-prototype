package com.example.testblefido2.old.webauthn.fido.hid;

import org.jetbrains.annotations.NotNull;

import com.example.testblefido2.old.webauthn.exceptions.CtapHidException;
import com.example.testblefido2.old.webauthn.exceptions.CtapHidException.CtapHidError;
import com.example.testblefido2.old.webauthn.fido.hid.Constants.CtapHidCommand;
import com.example.testblefido2.old.webauthn.fido.hid.Constants.CtapHidStatus;
    ...
    public abstract static class Packet {
        ...
        public static Packet parse(byte[] bytes) throws CtapHidException {
            ...
            if (bytes.length == (Constants.HID_REPORT_SIZE) + 1) {
                ...
                throw new CtapHidException(CtapHidError.InvalidLen);
            }
