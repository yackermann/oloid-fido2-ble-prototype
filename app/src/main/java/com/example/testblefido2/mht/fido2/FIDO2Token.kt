...
import com.example.testblefido2.mht.crypto.AppKey
...
class FIDO2Token(
    ...
    fun register(
        clientDataHash: ByteArray, relyingPartyId: String, credentialId: ByteArray,
        ...
        val attestationStatement =
            ES256PackedAttestationStatement(signMessage(relyingPartyId, dataToSign))

        val response =
            AuthenticatorMakeCredentials.Response(authenticatorData, attestationStatement)
    ...
    fun authenticate(
        credential: PublicKeyCredentialDescriptors,
